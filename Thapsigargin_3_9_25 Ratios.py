...
ratio_config = {
    '405_520/488_520': ('405_520', '488_520'),
    '405_520/540_580': ('405_520', '540_580'),
    '488_520/540_580': ('488_520', '540_580'),
    '540_580/(405_470+540_580)': (('405_470', '540_580'), '540_580'),
...
z_scores_405_520_488_520 = stats.zscore(merged_5['405_520/488_520'])
...
z_scores_df = pd.DataFrame({
    '405_520/488_520_zscore': z_scores_405_520_488_520,
...
def create_plate_grid(data, well_column, value_column):
    ...
    plate_405_520_488_520 = create_plate_grid(merged_with_wells, 'Well', '405_520/488_520_zscore')
    ...
    def plot_plate_heatmap(plate, title, cmap='coolwarm'):
        ...
        plt.yticks(np.arange(8) + 0.5, labels=['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'])
        plt.show()

    # Plot heatmaps for each z-score column
    plot_plate_heatmap(plate_405_520_488_520, '405_520/488_520 Z-Scores')
    plot_plate_heatmap(plate_Delta_F405_520, 'Delta_F405_520/F0_405_520 Z-Scores')
    plot_plate_heatmap(plate_Delta_F488_520, 'Delta_F488_520/F0_488_520 Z-Scores')
