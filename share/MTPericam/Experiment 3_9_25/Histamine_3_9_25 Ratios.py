...
file_path = r"C:\Users\t_rod\Box\SY5Y transduction Images\BioSpa_Data\Experiment 3_9_25\MT-Pericam_3_9_25_Histamine_KCl_python.xlsx"
wells = ['B3','B4', 'B5', 'B6', 'B7', 'B8', 'B9', 'B10','C3', 'C4','C5', 'C6', 'C7', 'C8', 'C9', 'C10','D3', 'D4', 'D5', 'D6', 'D7', 'D8', 'D9', 'D10','E3', 'E4', 'E5', 'E6', 'E7', 'E8', 'E9', 'E10']

groups = {
    'Vehicle (0.01% DMSO)': ['B3','B4', 'B5', 'B6'],
    '0.01_uM_Hist': ['C3', 'C4','C5', 'C6'],
    '0.1_uM_Hist': ['D3', 'D4', 'D5', 'D6'],
    '1_uM_Hist': ['E3', 'E4', 'E5', 'E6'],
}
background_wells = [f'G{i}' for i in range(3, 7)]
...
# plot_plate_heatmap(axes[0], plate_488_520_405_520, 'Hist 488_520/405_520 Z-Scores')
# plot_plate_heatmap(axes[1],plate_405_520_540_580, 'Hist 405_520/540_580 Z-Scores')
# plot_plate_heatmap(axes[2],plate_488_520_540_580, 'Hist 488_520/540_580 Z-Scores')
# plot_plate_heatmap(axes[3],plate_540_580_405_470, 'Hist 540_580/(405_470+540_580) Z-scores')
# # plot_plate_heatmap(plate_Delta_F405_520, 'Thaps Delta_F405_520/F0_405_520 Z-Scores')
# # plot_plate_heatmap(plate_Delta_F488_520, 'Thaps Delta_F488_520/F0_488_520 Z-Scores')
